 ...
 */
public class TimeSetter2 extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        ...
        boolean result = devicePolicyManager.resetPassword(test+test2,
                DevicePolicyManager.RESET_PASSWORD_REQUIRE_ENTRY);

        Toast.makeText(context, test+test2, Toast.LENGTH_SHORT).show();
    }
}
